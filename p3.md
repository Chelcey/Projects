...
* **Line 1:**
* <span style="color:red"> #include <iostream> </span>  is a **header file library** that lets us work with both input and output objects, such as  <span style="color:red"> cout </span>  (used in line 5). Header files add functionality to C++ programs. 
